...
Mux::Mux(int* input_1, int* input_2, int select)
{
...
int* Mux::getOutput(int select){
    setSelect(select);
    return getOutput();
}

int* Mux::getOutput(int* input_1,int* input_2, int select){
    setInput(input_1,input_2);
    setSelect(select);
    return getOutput();
}